...
def main(table, img, ocr, name_of_file, arff, out_img, write_path, model_file):
   ...
   # document_parser.write_to_csv_gt(p_arr, write_path+ "\\before_post\\" + name_of_file + "_csv_before")
    ...
    # Extracting words of detected table region and writing them to html
    UT.extract_table_wordss(write_path,name_of_file,final_table,arr_of_objects)
    
    # cal cal_accuracy function to compute the accuracy by words
    #UT.cal_accuracy_words(final_table, X, X_1, Y, Y_1, arr_of_objects, no_of_table, write_path + "\\Words_Accuracy\\" + name_of_file + "_words_Accuracy.csv")
    ...
    #UT.calc_accuracy_pixels(X, X_1, Y, Y_1, final_table,  img, write_path , name_of_file , no_of_table, arr_of_objects)
    ...
    #document_parser.write_to_csv_gt(p_arr, write_path+ "\\After_Post\\" + name_of_file + "_csv_after")
...
def batch_processor():
    dir_img = "F:\\KICS - Research Officer\\Document Analysis\\DATA SET\\Train Data\\Train Bulk"
...
def batch_processor_current():
    bulk_folder = "E:/KICS - Research Officer/Document Analysis/DATA SET/Test Data/New Bulk"
    extension = ".png"
